...
class ChannelUnitMetrics(CHaMPMetric):
    ...
    def calc(self, shpCUPath, shpThalweg, rasDepth, visitMetrics, dUnits, unitDefs):
        ...
        for tierKey, tierMetrics in { 'Tier1': dResultsTier1, 'Tier2': dResultsTier2}.iteritems():

...
class TIN(object):
    ...
    def generate_triangles(self, nodes, indices):
        triangles = {}
        for tindex, nodeindices in indices.iteritems():
    ...
    def generate_hull_polygons(self, nodes, hull_indices):
        ...
        for indexhull, hnodes in hull_polygon_nodes.iteritems():
    ...
    def generate_tin_nodes(self):
        ...
        return filter(prep_hull.covers, list(self.nodes.itervalues()))
